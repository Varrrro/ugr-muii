...
Al igual que para las pruebas realizadas en el capítulo
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{04-implementation/server.png}
...
En el listado de código \ref{lst:04-library_dockerfile} se muestra la definición
...
De manera muy similar a lo que sucedía con el servidor, para la librería también
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{04-implementation/deploy-latency.png}
...
El valor de $R^{2}$ del modelo obtenido no llega a ser muy alto, pero nos indica
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{04-implementation/deploy-latency-progression.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{04-implementation/deploy-latency-regression.png}
