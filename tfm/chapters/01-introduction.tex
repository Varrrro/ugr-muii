...
\begin{itemize}
      ...
      \item \textbf{Iteración 10} (09/11 - 23/11)
            \begin{itemize}
                  \item (Servidor) Escribir pruebas de integración.
                  \item (Servidor) Definir flujo de integración continua.
                  \item (Cliente) Escribir pruebas de integración.
...
En el capítulo 3, se aborda el diseño de una herramienta para el despliegue y
...
En el capítulo 4, se realiza una revisión del proyecto completo y se presentan
